    ...
    return (
        <div class="lws-task-list">
            ...
            <div class="lws-task">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        <img src="./images/avatars/salahuddin.png" class="team-avater" alt="salahuddin" />
            ...
            <div class="lws-task">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        <img src="/images/avatars/sumit.png" class="team-avater" alt="sumit" />
            ...
            <div class="lws-task">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        <img src="./images/avatars/sadh.png" class="team-avater" alt="sadh" />
            ...
            <div class="lws-task">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        <img src="./images/avatars/akash.png" class="team-avater" alt="akash" />
